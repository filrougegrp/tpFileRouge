...
CREATE TABLE IF NOT EXISTS `MATCH` (
  ...
  INDEX `fk_MATCH_PAYS1_idx` (`ID_PAYS_1` ASC),
  INDEX `fk_MATCH_PAYS2_idx` (`ID_PAYS_2` ASC),
  INDEX `fk_MATCH_POULE1_idx` (`ID_POULE` ASC),
  CONSTRAINT `fk_MATCH_PAYS1`
    FOREIGN KEY (`ID_PAYS_1`)
    REFERENCES `PAYS` (`ID_PAYS`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_MATCH_PAYS2`
    FOREIGN KEY (`ID_PAYS_2`)
    REFERENCES `PAYS` (`ID_PAYS`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_MATCH_POULE1`
...
CREATE TABLE IF NOT EXISTS `PRONOSTIC` (
  ...
  INDEX `fk_PRONOSTIC_MATCH1_idx` (`ID_MATCH` ASC),
  INDEX `fk_PRONOSTIC_SALARIE1_idx` (`ID_SALARIE` ASC),
  CONSTRAINT `fk_PRONOSTIC_MATCH1`
