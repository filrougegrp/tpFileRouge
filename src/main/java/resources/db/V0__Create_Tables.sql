...
CREATE TABLE IF NOT EXISTS `MATCHE` (
  ...
  INDEX `fk_MATCHE_PAYS1_idx` (`ID_PAYS_1` ASC),
  INDEX `fk_MATCHE_PAYS2_idx` (`ID_PAYS_2` ASC),
  INDEX `fk_MATCHE_POULE1_idx` (`ID_POULE` ASC),
  CONSTRAINT `fk_MATCHE_PAYS1`
    FOREIGN KEY (`ID_PAYS_1`)
    REFERENCES `PAYS` (`ID_PAYS`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_MATCHE_PAYS2`
    FOREIGN KEY (`ID_PAYS_2`)
    REFERENCES `PAYS` (`ID_PAYS`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_MATCHE_POULE1`
...
CREATE TABLE IF NOT EXISTS `PRONOSTIC` (
  ...
  INDEX `fk_PRONOSTIC_MATCHE1_idx` (`ID_MATCHE` ASC),
  INDEX `fk_PRONOSTIC_SALARIE1_idx` (`ID_SALARIE` ASC),
  CONSTRAINT `fk_PRONOSTIC_MATCHE1`
    FOREIGN KEY (`ID_MATCHE`)
    REFERENCES `MATCHE` (`ID_MATCHE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
